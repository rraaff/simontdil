...
public class EditDocumentSubTypeAction extends SimonAction {
	...
	public ActionForward basicExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		final DocumentSubTypeABMForm subCategoryABMForm = (DocumentSubTypeABMForm) form;
		final int userId = Integer.parseInt(request.getParameter("id"));
		TransactionProvider.executeInTransaction(new TransactionalAction() {
			public void executeInTransaction() throws SQLException, ValidationException {
				subCategoryABMForm.initWith(userId);
			}
		});
