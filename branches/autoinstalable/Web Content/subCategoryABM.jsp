...
<td width="100%">
<html:form method="POST" action="/subCategoryABM">
...
<table width="95%" height="560" border="0" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					...
					<td height="500" valign="top">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="93" align="right"><%=ResourceBundleCache.get(getServletInfo(), "categoria")%>:</td>
								<td width="7"><img src="images/null.gif" width="7" height="1"></td>
								<td width="250" align="left"><bean:write name="SubCategoryABMForm" property="categoryName" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="7"><img src="images/null.gif" width="7" height="1"></td>
								<td width="250" align="left"><html:text name="SubCategoryABMForm" property="name" styleClass="textfield_effect"/><html:errors property="subCategory.name" /></td>
							</tr>
							<tr>
								<td colspan="3" height="11"><img src="images/null.gif" width="1" height="11"></td>
							</tr>
							<tr>
								...
								<td width="7"><img src="images/null.gif" width="7" height="1"></td>
								<td width="250" align="left"><html:text name="SubCategoryABMForm" property="orderNumber" styleClass="textfield_effect"/><html:errors property="category.orderNumber" /></td>
							</tr>
							<tr>
								<td colspan="3" height="11"><img src="images/null.gif" width="1" height="11"></td>
							</tr>
							<tr>
								<td colspan="3" height="25" align="center">
									<logic:equal name="SubCategoryABMForm" property="id" value="0">
										<html:submit property="operation">
											<%=ResourceBundleCache.get(getServletInfo(), "crear")%>
										</html:submit>
									</logic:equal>
									<logic:notEqual name="SubCategoryABMForm" property="id" value="0">
										<html:submit property="operation">
						...
						<div id="main">
							<div id="lyr1" style="width:inherit;">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									...
									<logic:iterate name="SubCategoryABMForm" property="allSubCategory" id="iterSubCategory" indexId="iterIndex"> 
										<tr class="<%= (iterIndex % 2 == 0) ? "d0" : "d1" %>">
											<td <%= ((com.tdil.simon.data.model.PersistentObject)iterSubCategory).isDeleted() ? "class=\"notActive\"" : "" %> align="left"><bean:write name="iterSubCategory" property="name" /></td>
											<td <%= ((com.tdil.simon.data.model.PersistentObject)iterSubCategory).isDeleted() ? "class=\"notActive\"" : "" %> align="left"><bean:write name="iterSubCategory" property="orderNumber" /></td>
											<td><%=com.tdil.simon.web.ButtonGenerator.getNoOPButtonStart()%><html:link  action="editSubCategory.st?" paramName="iterSubCategory" paramProperty="id" paramId="id">
											...
											<td><logic:equal name="iterSubCategory" property="deleted" value="false">
													<%=com.tdil.simon.web.ButtonGenerator.getIndexedButton("SubCategoryABMForm","botones","desactivar", iterIndex)%>
												</logic:equal>
												<logic:equal name="iterSubCategory" property="deleted" value="true">
													<%=com.tdil.simon.web.ButtonGenerator.getIndexedButton("SubCategoryABMForm","botones","activar", iterIndex)%>
												</logic:equal>
											</td>
										</tr> 
									</logic:iterate>
	...
	<tr>
		<td colspan="3" align="center"><%=com.tdil.simon.web.ButtonGenerator.getNoOPButtonStart()%><html:link  action="editCategory.st?" paramName="SubCategoryABMForm" paramProperty="categoryId" paramId="id">
