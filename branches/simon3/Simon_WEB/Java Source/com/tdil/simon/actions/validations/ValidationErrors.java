...
public interface ValidationErrors {
	...
	String MODERATOR_CANNOT_BE_ASSISTANT = "MODERATOR_CANNOT_BE_ASSISTANT";
	String MODERATOR_CANNOT_BE_TRANSLATOR = "MODERATOR_CANNOT_BE_TRANSLATOR";
	String ASSISTANT_CANNOT_BE_TRANSLATOR = "ASSISTANT_CANNOT_BE_TRANSLATOR";
	...
	String SELECT_DOCUMENT_SUB_TYPE = "SELECT_DOCUMENT_TYPE";
	...
	String INVALID_DESTINATION_PARAGRAPH = "INVALID_DESTINATION_PARAGRAPH";
	String DESTINATION_CANNOT_BE_ORIGIN = "DESTINATION_CANNOT_BE_ORIGIN";
	String DESTINATION_UPPER_LIMIT_ERROR = "DESTINATION_UPPER_LIMIT_ERROR";
	...
	String CAN_NOT_DELETE_VERSION_IN_NEGOTIATION = "CAN_NOT_DELETE_VERSION_IN_NEGOTIATION";
	
	String INVALID_LOGO_TYPE = "INVALID_LOGO_TYPE";
	
	// DocumentType
	String DOCUMENT_TYPE_ALREADY_EXISTS = "DOCUMENT_TYPE_ALREADY_EXISTS";
	String DOCUMENT_SUB_TYPE_ALREADY_EXISTS = "DOCUMENT_SUB_TYPE_ALREADY_EXISTS";
	
	// SUbCategory
	String SUB_CATEGORY_ALREADY_EXISTS = "SUB_CATEGORY_ALREADY_EXISTS";
