						...
						<div id="main">
							<div id="lyr1" style="width:inherit;">
								<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
                                    ...
                                    <tr class="d0">
										<td height="28" align="left">PROJETO DECLARAÇÃO DE MAR DEL PLATA - V3</td>
                                    ...
                                    <tr class="dl">
										<td height="28" align="left">PROJETO COMUNICADO ESPECIAL SOBRE O "QHAPAQ ÑAN" - V2</td>
										<td><a href="other/Proy-Comunicado-Esp-Qhapaq-Nan--P.doc" target="_blank"><img src="images/buttons/descargar.png" width="74" height="24" border="0"></a></td>
									</tr>
                                    ...
                                    <!-- tr class="d1">
										<td height="28" align="left">RELATÓRIO DE ACTIVIDADES DA SECRETARIA-GERAL IBERO-AMERICANA</td>
