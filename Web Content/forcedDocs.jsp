				...
				<td colspan="3">
					<div id="newHomeBlock">
						<table width="95%" cellspacing="0" cellpadding="15" align="center">
							<tr>
								<td><span class="newHomeTitle"><%=ResourceBundleCache.get("delegateHome", "Documentos")%></span></td>
							</tr>
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
										<tr>
											<logic:iterate name="delegatePopupBean" property="principalVersions" id="doc" indexId="principalIndex">
												<td>
													<table width="370" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td><span class="mainDocsCategory"><bean:write name="doc" property="documentTypeName" /></span><br/>
																...
																<span class="mainDocsData"><%=ResourceBundleCache.get("delegateHome", "version")%>: <bean:write name="doc" property="number" /> - <bean:write name="doc" property="name" /></span></td>
														</tr>
													</table>
												</td>
											</logic:iterate>
