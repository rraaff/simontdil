...
<div id="content" style="height:13800px;">
	<div id="alcien" style="height:13800px; padding-top:20px;">
	<!-- inicio ayuda -->
		<div id="contenedor">
			<div id="menu">
				<a name="top" id="top"></a>
			...
			<div id="item">
				...
				<div id="cuerpo">
					...
					<div id="imagen" align="center">Vista del correo electrónico<br /><img src="images/help/mail00.jpg" width="650" height="471" border="0" /></div>
					<DIV id="texto"><br />Al presionar el botón "Ingresar al sitio" usted será dirigido al &quot;Sitio web exclusivo para delegaciones de la XX Cumbre iberoamericana&quot;, en dónde deberá ingresar seleccionando la opción <strong>"Usuarios Nuevos"</strong> para poder cambiar su clave.</DIV>
			...
			<div id="item">
				...
				<div id="cuerpo">
					...
					<div id="texto"><br />En esta pantalla usted pordrá elegir entre las siguientes opciones:<br />-	Ir a los documentos Principales:  "Proyecto de Declaración" y  "Plan de Acción"<br />-	Ir a los documentos Específicos<br />-	Ir a Documentos de consulta.</div><!--fin texto-->
				</div><!--fin cuerpo-->
			...
			<DIV id="item">
				...
				<div id="cuerpo">
					...
					<div id="texto"><br />En caso de proponer un párrafo nuevo usted deberá tildar la casilla "<strong>Solicitar como nuevo párrafo</strong>" e indicar la ubicación que el mismo debería ocupar en el documento en cuestión, completando el campo de texto que aparecerá a tal efecto.</div>
					...
					<div id="texto"><p>5.	Presione el botón "Agregar Observación". <br />Aparecerá una ventana que pedirá su confirmación sobre el envio de la observación, si usted está seguro que desea enviarla presione "aceptar". Aparecerá en pantalla una alerta indicando que su observación se ha enviado con &eacute;xito.</p></div>
			...
			<div id="item">
				...
				<div id="cuerpo">
					<div id="texto">1.	Usted puede descargar en un mismo archivo el documento original y el listado de observaciones realizadas.</div>
					<div id="imagen" align="center"><em>Vista de los botones "Descargar  PDF" y &quot;Descargar RTF&quot;</em>:<br /><img src="images/help/descarga01.jpg" width="599" height="343" /></div>
					<div id="texto"><br />Puede elegir entre los formatos PDF y RTF.<br />- Para descargar en formato PDF:<br />Presionar el bot&oacute;n &quot;Descargar PDF&quot;<br />- Para descargar en formato RTF:<br />Presionar el bot&oacute;n &quot;Descargar RTF&quot;<br /><p>Al presionar cualquiera de los botones "Descargar PDF" o &quot;Descargar RTF&quot; se abrirá un cuadro de dialogo  donde usted deberá indicar si desea abrir el documento o guardarlo en su disco rígido.<br />Para poder visualizar documentos de formato PDF usted necesita tener instalado en su ordenar el programa Adobe Acrobat Reader, si no lo posee puede descargarlo gratuitamente desde la siguiente dirección: <br /><br /><a href="http://get.adobe.com/es/reader/">http://get.adobe.com/es/reader/</a></p>
					</div>
				</div>
				<!--fin cuerpo-->
				<div id="subir"><a href="#top"><br />subir</a></div>
