<%@ page info="subCategoryPermissionABM"%>
...
<td width="100%">
<html:form method="POST" action="/subCategoryPermissionABM">
...
<table width="95%" height="560" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<td height="500" valign="top">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td width="250" align="left"><bean:write name="SubCategoryPermissionABMForm" property="userGroupName" /></td>
							</tr>
							<tr>
	...
	<tr>
		<td colspan="3" align="center"><%=com.tdil.simon.web.ButtonGenerator.getNoOPButtonStart()%><html:link  action="editUserGroup.st?" paramName="SubCategoryPermissionABMForm" paramProperty="userGroupId" paramId="id">
