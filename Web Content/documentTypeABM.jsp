...
<td width="100%">
<html:form method="POST" action="/documentTypeABM">
					...
					<td height="500" valign="top">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td width="250" align="left"><html:text name="DocumentTypeABMForm" property="name" styleClass="textfield_effect"/><html:errors property="documentType.name" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="7"><img src="images/null.gif" width="7" height="1"></td>
								<td width="250" align="left"><html:text name="DocumentTypeABMForm" property="orderNumber" styleClass="textfield_effect"/><html:errors property="documentType.orderNumber" /></td>
							</tr>
							<tr>
								<td colspan="3" height="11"><img src="images/null.gif" width="1" height="11"></td>
							</tr>
							<tr>
								<td colspan="3" height="25" align="center">
									<logic:equal name="DocumentTypeABMForm" property="id" value="0">
										<html:submit property="operation">
											<%=ResourceBundleCache.get(getServletInfo(), "crear")%>
										</html:submit>
									</logic:equal>
									<logic:notEqual name="DocumentTypeABMForm" property="id" value="0">
										<html:submit property="operation">
									...
									<logic:iterate name="DocumentTypeABMForm" property="allDocumentType" id="iterDocumentType" indexId="iterIndex"> 
										<tr class="<%= (iterIndex % 2 == 0) ? "d0" : "d1" %>">
											...
											<td><logic:equal name="iterDocumentType" property="deleted" value="false">
												...
												<logic:equal name="iterDocumentType" property="deleted" value="true">
													<%=com.tdil.simon.web.ButtonGenerator.getIndexedButton("DocumentTypeABMForm","botones","activar", iterIndex)%>
												</logic:equal>
											</td>
										</tr> 
									</logic:iterate>
