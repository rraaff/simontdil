	...
	<tr>
		...
		<td height="500" align="center" valign="top">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td width="150"><%=ResourceBundleCache.get(getServletInfo(), "clave")%>:</td>
					<td width="7"><img src="images/null.gif" width="7" height="1"></td>
					<td width="300"><html:text name="SysProperty" property="key" disabled="true" styleClass="textfield_effect_300"/></td>
					<td width="20"><img src="images/null.gif" width="20" height="1"></td>
					<td width="150"><%=ResourceBundleCache.get(getServletInfo(), "valor")%>:</td>
					<td width="7"><img src="images/null.gif" width="7" height="1"></td>
					<td width="300"><html:text name="SysProperty" property="value" styleClass="textfield_effect_300"/></td>
					<td width="20"><img src="images/null.gif" width="20" height="1"></td>
