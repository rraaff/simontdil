...
<body>
<div id="header">
	<div id="logo"><html:link action="/goToTranslatorHome" ><img src="./download.do?action=logo&fileId=header.logo" width="143" height="80" border="0"></html:link></div>
	<div id="blockinHeaderDelegate">
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="3" height="10" align="right"><html:link action="/logout" ><%=ResourceBundleCache.get("header", "salir")%></html:link> - <a href="ayuda.jsp"><%=ResourceBundleCache.get("header", "ayuda")%></a></td>
			</tr>
		</table>
	</div>
