				...
				<tr>
					...
					<!-- corte tabla template -->
						<table width="320" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="3" height="80"><p align="left">En caso de no recordar su contrase&ntilde;a, le sugerimos pedir un blanqu&eacute;o de la misma, completando su usuario, la direcci&oacute;n de E-Mail utilizada para su registraci&oacute;n y haciendo clic  en el bot&oacute;n &ldquo;solicitar contrase&ntilde;a&rdquo;.</p></td>
							</tr>
							<tr>
...
<div id="footer">
	<div id="copyright">SEGEC Secretar&iacute;a Ejecutiva XX Cumbre Iberoamericana<br>Esmeralda 1212, Ciudad Autónoma de Buenos Aires.<br>Código Postal: C1007ABR. República Argentina<br>Tel&eacute;fonos: +54 11 4819 7520 / +54 11 4819 7521</div>
