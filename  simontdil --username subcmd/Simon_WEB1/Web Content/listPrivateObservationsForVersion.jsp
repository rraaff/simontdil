					...
					<div id="portaTabla">
						<table width="920" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								...
								<td width="250">Dismiss</td>
							</tr>
							<logic:iterate name="ListPrivate" property="list" id="observation" indexId="iterIndex"> 
							<tr class="<%= (iterIndex % 2 == 0) ? "d0" : "d1" %>"><!-- En el iterador cambiar el style por d1 -->
								...
								<td><html:link  action="deletePrivateObservation.st?" paramName="observation" paramProperty="id" paramId="id">Borrar</html:link>
							</tr> 
							</logic:iterate>
							<tr>
								<td colspan="7" height="11"><img src="images/null.gif" width="1" height="11"></td>
