...
public class ObservationDAO {
	...
	public static Observation getObservation(int id) throws SQLException {
		return (Observation) IBatisManager.sqlMapper.queryForObject(
				"selectObservationById", id);
	}
	...
	public static void logicallyDeleteObservation(Observation Observation)
			throws SQLException {
	...
	public static Integer countPrivateObservationsForParagrapth(int paragraphdId) throws SQLException {
		return (Integer) IBatisManager.sqlMapper.queryForObject(
				"countPrivateObservationsForParagrapth", paragraphdId);
	}
}
